...
class CouponCode extends Model
{
    ...
    public static $typeMap = [
        self::TYPE_FIXED   => '固定金额（满减）',
        self::TYPE_PERCENT => '比例（百分比折扣）',
    ];
    ...
    protected $appends = ['description','value_title'];
    ...
    public function getDescriptionAttribute()
    {
        ...
        if ($this->type === self::TYPE_PERCENT) {
            $old_value = str_replace('.00', '', $this->value);
            $new_value = bcdiv($old_value,10,1);
            $value_title = str_replace('.0', '', $new_value).'折';
            return $str.'享'.$value_title.'优惠';
        }
